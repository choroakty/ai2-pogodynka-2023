...
class __TwigTemplate_98b05711dd0b434d40295e6c0a1347c6 extends Template
{
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        if ((isset($context["error"]) || array_key_exists("error", $context) ? $context["error"] : (function () { throw new RuntimeError('Variable "error" does not exist.', 6, $this->source); })())) {
            // line 7
            echo "        <div>";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans(twig_get_attribute($this->env, $this->source, (isset($context["error"]) || array_key_exists("error", $context) ? $context["error"] : (function () { throw new RuntimeError('Variable "error" does not exist.', 7, $this->source); })()), "massageKey", [], "any", false, false, false, 7), twig_get_attribute($this->env, $this->source, (isset($context["error"]) || array_key_exists("error", $context) ? $context["error"] : (function () { throw new RuntimeError('Variable "error" does not exist.', 7, $this->source); })()), "messageData", [], "any", false, false, false, 7), "security"), "html", null, true);
            echo "</div>
    ";
        }
        // line 9
        ...
        <input type=\"hidden\" name=\"_target_path\" value=\"/city\"/>
...
{% block body %}
    {% if error %}
        <div>{{ error.massageKey|trans(error.messageData, 'security') }}</div>
    {% endif %}
...
<div class=\"example-wrapper\">
    ...
    <ul>
        <li>Your controller at <code><a href=\"{{ 'I:/AI2-lab/labe/ai2-pogodynka-2023/src/Controller/LoginController.php'|file_link(0) }}\">src/Controller/LoginController.php</a></code></li>
        <li>Your template at <code><a href=\"{{ 'I:/AI2-lab/labe/ai2-pogodynka-2023/templates/login/index.html.twig'|file_link(0) }}\">templates/login/index.html.twig</a></code></li>
    </ul>
</div>
#}
{% endblock %}
", "login/index.html.twig", "I:\\AI2-lab\\labe\\ai2-pogodynka-2023\\templates\\login\\index.html.twig");
    }
}
