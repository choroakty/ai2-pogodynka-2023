...
class __TwigTemplate_15167af63aab0b676f4d3622091a82ce extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["forecasts"]) || array_key_exists("forecasts", $context) ? $context["forecasts"] : (function () { throw new RuntimeError('Variable "forecasts" does not exist.', 22, $this->source); })()));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["forecast"]) {
            ...
            echo "</td>
                <td>";
            // line 25
            ((twig_get_attribute($this->env, $this->source, $context["forecast"], "date", [], "any", false, false, false, 25)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["forecast"], "date", [], "any", false, false, false, 25), "Y-m-d"), "html", null, true))) : (print ("")));
            echo "</td>
                <td>";
            // line 26
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["forecast"], "celsius", [], "any", false, false, false, 26), "html", null, true);
            echo "</td>
                <td>";
            // line 27
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["forecast"], "wind", [], "any", false, false, false, 27), "html", null, true);
            echo "</td>
                <td>";
            // line 28
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["forecast"], "pressure", [], "any", false, false, false, 28), "html", null, true);
            echo "</td>
                <td>";
            // line 29
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["forecast"], "rain", [], "any", false, false, false, 29), "html", null, true);
            echo "</td>
                <td>";
            // line 30
            echo ((twig_get_attribute($this->env, $this->source, $context["forecast"], "isPartyTime", [], "any", false, false, false, 30)) ? ("Yes") : ("No"));
            echo "</td>
                <td>
            ...
            // line 33
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_forecast_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["forecast"], "id", [], "any", false, false, false, 33)]), "html", null, true);
            echo "\">Edit</a>
                </td>
            </tr>
        ";
...
{% endblock %}
", "forecast/index.html.twig", "I:\\AI2-lab\\labe\\ai2-pogodynka-2023\\templates\\forecast\\index.html.twig");
    }
}
